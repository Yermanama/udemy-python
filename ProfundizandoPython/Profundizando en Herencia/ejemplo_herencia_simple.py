...
class ListaEnteros(ListaSimple):
    ...
    def agregar(self, elemento):
        self._validar(elemento)
        # Una vez validado podemos agregarlo
        super().agregar(elemento)

# lista_simple = ListaSimple([5,3,6,8])
# print(lista_simple) # Objeto ListaSimple([5,3,6,8])

lista_ordenada = ListaOrdenada([4,3,6,9,-1])
...
# Lista entero
# lista_enteros = ListaEnteros(['hila', 1, 2, 3])
lista_enteros =ListaEnteros([1,2,3,4])
print(lista_enteros)